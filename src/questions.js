export const questions = [
  ...
  {
    id: 4,
    question: "Qual serviço da AWS deve um engenheiro de nuvem usar para visualizar chamadas de API para serviços da AWS?",
    options: [
  ...
  },
  {
    ...
    explanation: "AWS Artifact é o serviço da AWS que pode fornecer documentos de segurança e conformidade para uma auditoria futura. O AWS Artifact é um portal de autoatendimento que permite aos usuários acessar e baixar relatórios de conformidade e acordos da AWS. Esses documentos fornecem evidências da conformidade da AWS com padrões e regulamentações de segurança globais, regionais e específicos da indústria.",
  },
  {
    id: 7,
    question: "Uma empresa está hospedando um aplicativo web em um contêiner Docker no Amazon EC2. A AWS é responsável por qual das seguintes tarefas?",
    options: [
      { id: "a", text: "Realizar manutenção de hardware nas instalações da AWS que executam a Nuvem AWS", correct: true },
      { id: "b", text: "Escalar a aplicação web e os serviços desenvolvidos com Docker", correct: false },
      { id: "c", text: "Gerenciar o sistema operacional convidado, incluindo atualizações e patches de segurança", correct: false },
      { id: "d", text: "Provisionamento ou agendamento de contêineres para executar em clusters e manter sua disponibilidade", correct: false },
    ],
    explanation: "A AWS é responsável pela manutenção do hardware nas instalações da AWS que executam a AWS Cloud. Isso faz parte do modelo de responsabilidade compartilhada, onde a AWS é responsável pela segurança da nuvem, e o cliente é responsável pela segurança na nuvem. A AWS também é responsável pela infraestrutura global que executa todos os serviços oferecidos na AWS Cloud, incluindo hardware, software, rede e instalações que executam os serviços da AWS. O cliente é responsável pelo sistema operacional convidado, incluindo atualizações e patches de segurança, bem como pela aplicação web e serviços desenvolvidos com Docker.",
  },
  {
    id: 8,
    question: "Qual serviço ou recurso da AWS é usado para solucionar problemas de conectividade de rede entre instâncias Amazon EC2?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "e", text: "Amazon DocumentDB (com compatibilidade com MongoDB)", correct: false },
    ],
    explanation: "Amazon Aurora e Amazon RDS são serviços da AWS que a empresa poderia usar para os bancos de dados relacionais. Amazon Aurora é um banco de dados relacional compatível com MySQL e PostgreSQL. Amazon Aurora é um serviço totalmente gerenciado, escalável e de alto desempenho que oferece até cinco vezes o rendimento do MySQL padrão e até três vezes o rendimento do PostgreSQL padrão. Amazon RDS é um serviço que permite aos usuários configurar, operar e escalar bancos de dados relacionais na nuvem. Amazon RDS suporta seis mecanismos de banco de dados populares: MySQL, PostgreSQL, Oracle, SQL Server, MariaDB e Amazon Aurora. As outras opções estão incorretas porque não são serviços da AWS que a empresa poderia usar para os bancos de dados relacionais. Amazon DocumentDB (compatível com MongoDB) é um banco de dados de documentos compatível com MongoDB. Amazon Neptune é um banco de dados de grafos que suporta modelos de grafos de propriedade e RDF. Amazon DynamoDB é um banco de dados de chave-valor e documentos. Referência: Amazon Aurora, Amazon RDS",
  },
  {
    id: 13,
    question: "Uma Zona de Disponibilidade consiste em:",
    options: [
      { id: "a", text: "um ou mais data centers em uma única localização.", correct: true },
      { id: "b", text: "dois ou mais hosts físicos em múltiplos data centers.", correct: false },
      { id: "c", text: "dois ou mais data centers em várias localizações.", correct: false },
      { id: "d", text: "um ou mais hosts físicos em um único data center.", correct: false },
    ],
    explanation: "Zona de Disponibilidade consiste em um ou mais data centers em um único local. Uma Zona de Disponibilidade é um local isolado dentro de uma Região da AWS que possui energia, resfriamento e rede independentes. Cada Zona de Disponibilidade tem um ou mais data centers que hospedam os servidores físicos e dispositivos de armazenamento que executam os serviços da AWS. As outras opções estão incorretas porque não são descrições precisas de uma Zona de Disponibilidade. Dois ou mais data centers em várias localizações não são uma Zona de Disponibilidade, mas sim várias Zonas de Disponibilidade dentro de uma Região da AWS. Um ou mais hosts físicos em um único data center não são uma Zona de Disponibilidade, mas sim os componentes de um data center dentro de uma Zona de Disponibilidade. Dois ou mais hosts físicos em vários data centers não são uma Zona de Disponibilidade, mas sim os componentes de vários data centers dentro de uma ou mais Zonas de Disponibilidade. Referência: [Regiões, Zonas de Disponibilidade e Zonas Locais]",
  },
  {
    id: 14,
    question: "Quais são as vantagens de migrar para a nuvem da AWS? (Selecione DUAS.)",
    options: [
      { id: "a", text: "A capacidade de usar o modelo pay-as-you-go.", correct: true },
      { id: "b", text: "Não precisar mais adivinhar a capacidade que será necessária.", correct: true },
      { id: "c", text: "A capacidade de transferir a responsabilidade de toda a segurança para a AWS.", correct: false },
      { id: "d", text: "A capacidade de ter controle total sobre a infraestrutura física.", correct: false },
      { id: "e", text: "Não se preocupar mais com controles de acesso dos usuários.", correct: false },
    ],
    explanation: "As vantagens de migrar para a AWS Cloud são a capacidade de usar o modelo pay-as-you-go e não precisar mais adivinhar qual capacidade será necessária. O modelo pay-as-you-go permite que o usuário pague apenas pelos recursos que usa, sem compromissos antecipados ou de longo prazo. Isso reduz o custo e o risco de superprovisionar ou subprovisionar recursos. Não precisar mais adivinhar qual capacidade será necessária significa que o usuário pode dimensionar seus recursos para cima ou para baixo conforme a demanda, sem gastar dinheiro em recursos ociosos ou perder clientes devido à capacidade insuficiente.",
  },
  {
    id: 15,
    question: "Qual opção é uma vantagem da computação em nuvem da AWS que minimiza os custos variáveis?",
    options: [
    ...
    explanation: "Uma das vantagens da computação em nuvem da AWS é que ela minimiza os custos variáveis ao aproveitar as economias de escala. Isso significa que a AWS pode alcançar custos mais baixos por unidade de recursos de computação ao distribuir os custos fixos de construção e manutenção dos data centers por um grande número de clientes. Como resultado, a AWS pode oferecer preços mais baixos e previsíveis para seus clientes, que pagam apenas pelos recursos que consomem.",
  },
  {
    id: 16,
    question: "Qual dos seguintes é um benefício de desacoplar uma arquitetura de nuvem da AWS?",
    options: [
      { id: "a", text: "Capacidade de atualizar componentes independentemente", correct: true },
  ...
  {
    id: 18,
    question: "Uma empresa recentemente migrou para a Nuvem AWS. A empresa precisa determinar se suas instâncias Amazon EC2 recém-importadas são do tamanho e tipo apropriados. Quais serviços da AWS podem fornecer essas informações para a empresa? (Selecione DUAS.)",
    options: [
  ...
  {
    id: 19,
    question: "Um desenvolvedor precisa criar um aplicativo para uma empresa de varejo. O aplicativo deve fornecer recomendações de produtos em tempo real com base em aprendizado de máquina. Qual serviço da AWS o desenvolvedor deve usar para atender a esse requisito?",
    options: [
    ...
    explanation: "O Amazon Personalize é um serviço de machine learning totalmente gerenciado que os clientes podem usar para gerar recomendações personalizadas para seus usuários. Ele também pode gerar segmentos de usuários com base na afinidade dos usuários por determinados itens ou metadados de itens. O Amazon Personalize usa os dados dos clientes para treinar e implantar modelos de recomendação personalizados que podem ser integrados em suas aplicações.",
  },
  {
    id: 20,
    question: "Quando um usuário quer utilizar suas licenças de software existentes por soquete, por núcleo ou por máquina virtual para um servidor Microsoft Windows em execução na AWS, qual tipo de instância do Amazon EC2 é necessário?",
    options: [
  ...
  },
  {
    ...
    explanation: "Amazon Workspaces é o serviço da AWS que fornece a funcionalidade de acessar remotamente desktops virtuais da internet. O Amazon Workspaces é uma solução de desktop como serviço (DaaS) totalmente gerenciada e segura que permite aos usuários provisionar desktops virtuais baseados em nuvem e acessá-los de qualquer lugar, usando qualquer dispositivo compatível. O Amazon Workspaces ajuda os usuários a reduzir a complexidade e o custo de gerenciar e manter desktops físicos, além de proporcionar uma experiência de usuário consistente e segura.",
  },
  {
    id: 22,
    question: "Uma empresa tem armazenado relatórios mensais em um bucket do Amazon S3. A empresa exporta os dados dos relatórios para arquivos de valores separados por vírgulas (.csv). Um desenvolvedor deseja escrever uma consulta simples que possa ler todos esses arquivos e gerar um relatório resumido. Qual serviço ou recurso da AWS o desenvolvedor deve usar para atender a esses requisitos com a MENOR quantidade de esforço operacional?",
    options: [
  ...
  },
  {
    ...
    explanation: "O Amazon RDS suporta seis mecanismos de banco de dados: Amazon Aurora, MySQL, MariaDB, PostgreSQL, Oracle e SQL Server. Apache Cassandra, MongoDB e Neo4j não são compatíveis com o Amazon RDS. Você pode saber mais sobre o Amazon RDS e seus mecanismos de banco de dados suportados nesta página.",
  },
  {
    id: 24,
    question: "Uma empresa tem uma plataforma de mídia social onde os usuários enviam e compartilham fotos com outros usuários. A empresa quer identificar e remover fotos inadequadas. A empresa não tem cientistas de aprendizado de máquina (ML) e deve construir essa capacidade de detecção sem expertise em ML. Qual serviço da AWS a empresa deve usar para construir essa capacidade?",
    options: [
  ...
  {
    id: 27,
    question: "Uma empresa implanta seu aplicativo em várias Regiões da AWS e configura failover automático entre essas Regiões. Qual conceito de nuvem essa arquitetura representa?",
    options: [
  ...
  {
    id: 29,
    question: "Uma empresa tem duas contas AWS em uma organização no AWS Organizations para faturamento consolidado. Todos os recursos da AWS da empresa estão hospedados em uma Região AWS. A Conta A comprou cinco Instâncias Reservadas Padrão (RIs) da Amazon EC2 e tem quatro instâncias EC2 em execução. A Conta B não comprou nenhuma RI e também tem quatro instâncias EC2 em execução. Qual declaração é verdadeira sobre o preço dessas oito instâncias?",
    options: [
      { id: "a", text: "Quatro instâncias serão cobradas como RIs, e quatro serão cobradas como instâncias regulares.", correct: true },
      { id: "b", text: "As oito instâncias serão cobradas como instâncias regulares.", correct: false },
      { id: "c", text: "As oito instâncias serão cobradas como RIs.", correct: false },
      { id: "d", text: "Cinco instâncias serão cobradas como RIs, e três serão cobradas como instâncias regulares.", correct: false },
    ],
    explanation: "A afirmação verdadeira em relação ao preço dessas oito instâncias é: quatro instâncias serão cobradas como RIs e quatro serão cobradas como instâncias regulares. As Reservas de Instâncias (RIs) do Amazon EC2 são um modelo de precificação que permite aos usuários reservar instâncias EC2 por um período específico e beneficiar-se de taxas horárias com desconto e reserva de capacidade. As RIs são compradas para uma região específica da AWS e podem ser compartilhadas entre várias contas em uma organização no AWS Organizations para cobrança consolidada. No entanto, as RIs são aplicadas por ordem de chegada e não há garantia de que todas as instâncias na organização serão cobradas à taxa de RI. Neste caso, a Conta A comprou cinco RIs e tem quatro instâncias em execução, então todas as quatro instâncias serão cobradas à taxa de RI. A Conta B não comprou nenhuma RI e também tem quatro instâncias em execução, então todas as quatro instâncias serão cobradas à taxa regular. A RI restante na Conta A não será aplicada a nenhuma instância na Conta B e será desperdiçada.",
  },
  {
    id: 30,
    question: "Qual recurso da Nuvem AWS dá aos usuários a capacidade de pagar com base nas necessidades atuais em vez das necessidades previstas?",
    options: [
      { id: "a", text: "Preços pay-as-you-go (pague conforme o uso)", correct: true },
      { id: "b", text: "Savings Plans", correct: false },
      { id: "c", text: "AWS Budgets", correct: false },
      { id: "d", text: "Descontos por volume", correct: false },
    ],
    explanation: "A precificação pay-as-you-go é uma característica da AWS Cloud que permite aos usuários pagar com base nas necessidades atuais, em vez de necessidades previstas. Isso significa que os usuários pagam apenas pelos serviços e recursos da AWS que utilizam, sem compromissos antecipados ou de longo prazo. Isso permite que os usuários escalem seu uso conforme necessário, evitando pagar por capacidade ociosa ou não utilizada. A precificação pay-as-you-go também permite que os usuários se beneficiem das economias de escala e dos custos mais baixos da AWS à medida que seus negócios crescem.",
  },
  {
    id: 31,
    question: "Uma grande empresa tem uma carga de trabalho que requer que o hardware permaneça no local. A empresa quer usar os mesmos serviços de gerenciamento e controle que atualmente usa na AWS. Qual serviço da AWS a empresa deve usar para atender a esses requisitos?",
    options: [
  ...
  },
  {
    ...
    explanation: "AWS Pricing Calculator pode ser usado para estimar custos antes da implantação. AWS Pricing Calculator é uma ferramenta que ajuda o usuário a comparar o custo dos serviços da AWS para diferentes casos de uso e configurações. O usuário pode criar estimativas para vários serviços da AWS, como Amazon EC2, Amazon S3, Amazon RDS e mais. O usuário também pode ajustar os parâmetros, como região, tipo de instância, tamanho do armazenamento e duração, para ver como eles afetam o custo. O AWS Pricing Calculator fornece uma discriminação detalhada do custo estimado, bem como um resumo dos principais fatores que influenciam o custo.",
  },
  {
    id: 38,
    question: "Uma empresa está usando um serviço de terceiros para fazer backup de 10 TB de dados em uma biblioteca de fitas. O servidor de backup local está ficando sem espaço. A empresa quer usar os serviços da AWS para os backups sem alterar seus fluxos de trabalho de backup existentes. Qual serviço da AWS a empresa deve usar para atender a esses requisitos?",
    options: [
      { id: "a", text: "AWS Storage Gateway", correct: true },
      { id: "b", text: "AWS Lambda", correct: false },
      { id: "c", text: "Amazon Elastic Block Store (Amazon EBS)", correct: false },
      { id: "d", text: "Amazon Elastic Container Service (Amazon ECS)", correct: false },
    ],
  ...
  {
    id: 39,
    question: "Qual serviço ou ferramenta da AWS ajuda a gerenciar centralmente o faturamento e permitir o acesso controlado a recursos entre contas da AWS?",
    options: [
      { id: "a", text: "AWS Organizations", correct: true },
      { id: "b", text: "AWS Identity and Access Management (IAM)", correct: false },
      { id: "c", text: "AWS Budgets", correct: false },
    ...
    explanation: "AWS Organizations ajuda a gerenciar centralmente a cobrança e permitir acesso controlado a recursos entre contas da AWS. AWS Organizations é um serviço que permite ao usuário consolidar várias contas da AWS em uma organização que pode ser gerenciada como uma unidade única. O AWS Organizations permite que o usuário crie grupos de contas e aplique políticas a eles, como políticas de controle de serviço (SCPs) que especificam os serviços e ações que usuários e funções podem acessar nas contas. O AWS Organizations também permite que o usuário use cobrança consolidada, que combina o uso e as cobranças de todas as contas da organização em uma única fatura.",
  },
  {
    id: 40,
    question: "Quais são as características das Zonas de Disponibilidade? (Selecione DUAS.)",
    options: [
      { id: "a", text: "Zonas de Disponibilidade dentro de uma região da AWS compartilham energia redundante, rede e conectividade.", correct: true },
      { id: "b", text: "Todas as Zonas de Disponibilidade em uma Região da AWS são interconectadas com uma rede de alta largura de banda e baixa latência.", correct: true },
      { id: "c", text: "As Zonas de Disponibilidade são fisicamente separadas por uma distância mínima de 150 km (100 milhas).", correct: false },
      { id: "d", text: "Todo o tráfego entre as Zonas de Disponibilidade é criptografado.", correct: false },
      { id: "e", text: "Cada Zona de Disponibilidade contém um único data center.", correct: false },
    ],
    explanation: "As Zonas de Disponibilidade são locais fisicamente separados dentro de uma Região da AWS que são projetados para serem isolados de falhas. Cada Zona de Disponibilidade possui energia, refrigeração e segurança física independentes e está conectada a outras Zonas de Disponibilidade na mesma Região por uma rede de baixa latência.",
  },
  {
    id: 41,
    question: "Uma empresa precisa executar código em resposta a uma notificação de evento que ocorre quando objetos são carregados em um bucket do Amazon S3. Qual serviço da AWS se integrará diretamente com a notificação de evento?",
    options: [
      { id: "a", text: "AWS Lambda", correct: true },
      { id: "b", text: "Amazon EC2", correct: false },
      { id: "c", text: "AWS Elastic Beanstalk", correct: false },
      { id: "d", text: "Amazon Elastic Container Registry (Amazon ECR)", correct: false },
    ],
  ...
  },
  {
    ...
    explanation: "O pilar do AWS Well-Architected Framework que é apoiado pelos objetivos de proteger informações, sistemas e ativos da AWS Cloud enquanto realiza avaliações de risco e tarefas de mitigação é segurança. Segurança é a capacidade de proteger informações, sistemas e ativos enquanto entrega valor de negócio por meio de avaliações de risco e estratégias de mitigação. O pilar de segurança cobre tópicos como gerenciamento de identidade e acesso, proteção de dados, proteção de infraestrutura, controles de detecção, resposta a incidentes e conformidade.",
  },
  {
    id: 44,
    question: "Uma empresa usa Amazon Workspaces. O que um usuário pode realizar usando o AWS CloudTrail?",
    options: [
      { id: "a", text: "Registrar chamadas de API feitas para os serviços da AWS.", correct: true },
      { id: "b", text: "Avaliar a conformidade das configurações dos recursos da AWS com políticas e diretrizes.", correct: false },
      { id: "c", text: "Garantir que as instâncias Amazon EC2 estejam atualizadas com os últimos patches de segurança.", correct: false },
      { id: "d", text: "Gerar um relatório de credenciais de usuários IAM.", correct: false },
    ],
  ...
  {
    id: 45,
    question: "Qual serviço da AWS um profissional de nuvem deve usar para receber orientações em tempo real para provisionamento de recursos, com base nas melhores práticas da AWS relacionadas à segurança, otimização de custos e limites de serviço?",
    options: [
      { id: "a", text: "AWS Trusted Advisor", correct: true },
  ...
  {
    id: 46,
    question: "Qual pilar do AWS Well-Architected Framework se concentra na capacidade de executar cargas de trabalho de forma eficaz, obter insights sobre operações e melhorar continuamente os processos e procedimentos de suporte?",
    options: [
  ...
  },
  {
    ...
    explanation: "Amazon QuickSight é um serviço da AWS que fornecerá os painéis e gráficos para os insights dos dados de negócios. O Amazon QuickSight é um serviço de inteligência de negócios totalmente gerenciado, escalável e sem servidor que permite aos usuários criar e compartilhar painéis e gráficos interativos. O Amazon QuickSight pode se conectar a várias fontes de dados, como Amazon S3, Amazon RDS, Amazon Redshift e mais. O Amazon QuickSight também fornece aos usuários insights de aprendizado de máquina, como detecção de anomalias, previsão e narrativas em linguagem natural. As outras opções estão incorretas porque não são serviços da AWS que fornecerão os painéis e gráficos para os insights dos dados de negócios. O Amazon Macie é um serviço da AWS que ajuda os usuários a descobrir, classificar e proteger dados confidenciais armazenados no Amazon S3. O Amazon Aurora é um serviço da AWS que fornece um banco de dados relacional compatível com MySQL e PostgreSQL. O AWS CloudTrail é um serviço da AWS que permite aos usuários rastrear a atividade dos usuários e o uso de APIs em sua conta da AWS. Referência: Amazon QuickSight FAQs",
  },
  {
    id: 48,
    question: "Quais são algumas vantagens de usar instâncias do Amazon EC2 para hospedar aplicativos na Nuvem AWS em vez de localmente? (Selecione DUAS.)",
    options: [
      { id: "a", text: "EC2 integra-se com Amazon VPC, AWS CloudTrail e AWS Identity and Access Management (IAM).", correct: true },
      { id: "b", text: "EC2 possui um modelo de preços flexível, pay-as-you-go.", correct: true },
      { id: "c", text: "EC2 tem otimização automática de custo de armazenamento.", correct: false },
      { id: "d", text: "O EC2 inclui gerenciamento de patches do sistema operacional.", correct: false },
      { id: "e", text: "EC2 tem um acordo de nível de serviço (SLA) de 100%.", correct: false },
    ],
    explanation: "Algumas das vantagens de usar instâncias Amazon EC2 para hospedar aplicações na AWS Cloud, em vez de no local, são: EC2 se integra com Amazon VPC, AWS CloudTrail e AWS Identity and Access Management (IAM). O Amazon VPC permite provisionar uma seção logicamente isolada da AWS Cloud onde você pode lançar recursos da AWS em uma rede virtual que você define. O AWS CloudTrail possibilita a governança, conformidade, auditoria operacional e auditoria de risco da sua conta da AWS. O AWS IAM permite gerenciar o acesso aos serviços e recursos da AWS de forma segura.",
  },
  {
    id: 49,
    question: "Uma empresa precisa de uma rede de entrega de conteúdo que forneça entrega segura de dados, vídeos, aplicativos e APIs para usuários globalmente com baixa latência e altas velocidades de transferência. Qual serviço da AWS atende a esses requisitos?",
    options: [
  ...
  {
    id: 61,
    question: "Uma empresa quer usar um serviço gerenciado para simplificar a configuração, operação e escalabilidade de seu banco de dados MySQL na Nuvem AWS. Qual serviço da AWS atenderá a esses requisitos?",
    options: [
      { id: "a", text: "Amazon RDS", correct: true },
    ...
    explanation: "Amazon RDS é o serviço da AWS que atenderá aos requisitos de usar um serviço gerenciado para simplificar a configuração, operação e escalabilidade de um banco de dados MySQL na AWS Cloud. O Amazon RDS é um serviço de banco de dados relacional que suporta MySQL e outros motores de banco de dados populares. O Amazon RDS lida com tarefas rotineiras de banco de dados, como provisionamento, aplicação de patches, backup, recuperação e escalabilidade. O Amazon RDS também oferece alta disponibilidade, segurança e recursos de compatibilidade.",
  },
  {
    id: 62,
    question: "Uma empresa refinou sua carga de trabalho para usar serviços específicos da AWS para melhorar a eficiência e reduzir custos. Qual tarefa é responsabilidade do cliente, de acordo com o modelo de responsabilidade compartilhada da AWS?",
    options: [
      { id: "a", text: "Gerenciamento dos sistemas operacionais convidados", correct: true },
      { id: "b", text: "Gerenciamento dos sistemas operacionais host e virtualização", correct: false },
      { id: "c", text: "Manutenção do software que alimenta as Zonas de Disponibilidade", correct: false },
      { id: "d", text: "Manutenção da configuração de dispositivos de infraestrutura", correct: false },
    ],
    explanation: "O gerenciamento dos sistemas operacionais convidados é uma responsabilidade do cliente, de acordo com o modelo de responsabilidade compartilhada da AWS. O modelo de responsabilidade compartilhada da AWS define as diferentes responsabilidades de segurança e conformidade da AWS e do cliente. A AWS é responsável pela segurança da nuvem, que inclui a infraestrutura física, hardware, software e instalações que executam a AWS Cloud. O cliente é responsável pela segurança na nuvem, que inclui a configuração e o gerenciamento dos sistemas operacionais convidados, aplicações, dados e proteção do tráfego de rede.",
  },
  {
    id: 63,
    question: "O gerenciamento dos sistemas operacionais convidados é uma responsabilidade do cliente, de acordo com o modelo de responsabilidade compartilhada da AWS. O modelo de responsabilidade compartilhada da AWS define as diferentes responsabilidades de segurança e conformidade da AWS e do cliente. A AWS é responsável pela segurança da nuvem, que inclui a infraestrutura física, hardware, software e instalações que executam a AWS Cloud. O cliente é responsável pela segurança na nuvem, que inclui a configuração e o gerenciamento dos sistemas operacionais convidados, aplicações, dados e proteção do tráfego de rede.",
    options: [
      { id: "a", text: "Amazon Cognito", correct: true },
      { id: "b", text: "AWS Identity and Access Management (IAM)", correct: true },
      { id: "c", text: "AWS CodeStar", correct: false },
      { id: "d", text: "AWS Lambda", correct: false },
      { id: "e", text: "AWS License Manager", correct: false },
    ],
    explanation: "Os serviços de autenticação de usuário gerenciados pela AWS são: Amazon Cognito e AWS Identity and Access Management (IAM). Esses serviços ajudam os usuários a gerenciar e controlar de forma segura o acesso aos seus recursos e aplicações AWS. O Amazon Cognito é um serviço que fornece cadastro de usuário, login e controle de acesso para aplicações web e móveis. O Amazon Cognito suporta vários provedores de identidade, como Facebook, Google e Amazon, bem como pools de usuários personalizados. O AWS IAM é um serviço que permite aos usuários criar e gerenciar usuários, grupos, funções e permissões para serviços e recursos da AWS. O AWS IAM suporta vários métodos de autenticação, como senhas, chaves de acesso e autenticação multifator (MFA).",
  },
  {
    id: 64,
    question: "Quais princípios de design suportam o pilar de confiabilidade do AWS Well-Architected Framework? (Selecione DUAS.)",
    options: [
      { id: "a", text: "Recuperar automaticamente de falhas.", correct: true },
      { id: "b", text: "Escalar automaticamente para atender à demanda.", correct: true },
      { id: "c", text: "Implantar recursos globalmente para melhorar o tempo de resposta.", correct: false },
      { id: "d", text: "Executar operações como código.", correct: false },
      { id: "e", text: "Habilitar rastreabilidade.", correct: false },
    ],
    explanation: "Os princípios de design que apoiam o pilar de confiabilidade do AWS Well-Architected Framework são: escalabilidade automática para atender à demanda e recuperação automática de falhas. Esses princípios ajudam os usuários a projetar sistemas que podem lidar com mudanças na carga, evitar interrupções e retomar operações normais rapidamente. Escalar automaticamente para atender à demanda significa ajustar a capacidade do sistema com base na carga de trabalho atual e antecipada, usando serviços como AWS Auto Scaling, Amazon EC2 e AWS Lambda. Recuperar automaticamente de falhas significa detectar e resolver problemas, usando serviços como Amazon CloudWatch, AWS CloudFormation e AWS CloudTrail.",
  },
  {
    id: 65,
    question: "Uma empresa quer garantir que duas instâncias do Amazon EC2 estejam em centros de dados separados com latência mínima de comunicação entre os centros de dados. Como a empresa pode atender a esse requisito?",
    options: [
      { id: "a", text: "Coloque as instâncias EC2 em duas Zonas de Disponibilidade separadas dentro da mesma Região da AWS.", correct: true },
      { id: "b", text: "Coloque ambas as instâncias EC2 em um grupo de colocação para largura de banda dedicada.", correct: false },
      { id: "c", text: "Coloque as instâncias EC2 em duas Regiões da AWS separadas, conectadas com uma conexão de peering VPC.", correct: false },
      { id: "d", text: "Coloque uma instância EC2 on-premises e a outra em uma Região da AWS. Em seguida, conecte-as usando uma conexão VPN da AWS.", correct: false },
    ],
    explanation: "Colocar as instâncias do EC2 em duas Zonas de Disponibilidade separadas dentro da mesma Região da AWS é a melhor maneira de atender ao requisito. Zonas de Disponibilidade são locais isolados dentro de uma Região da AWS que possuem energia, resfriamento e rede independentes. Os usuários podem lançar seus recursos, como instâncias do Amazon EC2, em várias Zonas de Disponibilidade para aumentar a tolerância a falhas e a resiliência de suas aplicações. As Zonas de Disponibilidade dentro da mesma Região da AWS estão conectadas com rede de baixa latência, alta capacidade e altamente redundante. As outras opções estão incorretas porque não são as melhores maneiras de atender ao requisito. Colocar as instâncias do EC2 em duas Regiões da AWS separadas conectadas com uma conexão de emparelhamento de VPC não é a melhor maneira de atender ao requisito porque as Regiões da AWS são geograficamente dispersas e podem ter maior latência de comunicação entre elas do que as Zonas de Disponibilidade dentro da mesma Região da AWS. A conexão de emparelhamento de VPC é uma conexão de rede entre dois VPCs que permite aos usuários rotear o tráfego entre eles usando endereços IP privados. Colocar uma instância do EC2 no local e a outra em uma Região da AWS, e depois conectá-las usando uma conexão de VPN da AWS não é a melhor maneira de atender ao requisito porque o local e a Região da AWS são geograficamente dispersos e podem ter maior latência de comunicação entre eles do que as Zonas de Disponibilidade dentro da mesma Região da AWS. A conexão de VPN da AWS é uma conexão segura e criptografada entre uma rede do usuário e seu VPC. Colocar ambas as instâncias do EC2 em um grupo de posicionamento para largura de banda dedicada não é a melhor maneira de atender ao requisito porque um grupo de posicionamento é uma agrupamento lógico de instâncias dentro de uma única Zona de Disponibilidade que permite aos usuários lançar instâncias com características específicas de desempenho. Um grupo de posicionamento não garante que as instâncias estejam em data centers separados, e não fornece comunicação de baixa latência entre instâncias em diferentes Zonas de Disponibilidade",
  },
];
